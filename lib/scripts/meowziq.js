...
module.exports = function(robot) {
  var INTERVAL, pattern, playing, watch;
  ...
  pattern = new RegExp((config.meowbot ? '' : 'meowziq ') + 'play');
  ...
  pattern = new RegExp((config.meowbot ? '' : 'meowziq ') + 'skip');
  robot.respond(pattern, function(res) {
    var message;
    message = null;
    return request({
  ...
  pattern = new RegExp((config.meowbot ? '' : 'meowziq ') + 'status');
  robot.respond(pattern, function(res) {
    var message;
    message = null;
    return request(config.url + '/status').then(function(r) {
  ...
  pattern = new RegExp((config.meowbot ? '' : 'meowziq ') + 'stop');
  robot.respond(pattern, function(res) {
    var message;
    message = null;
    return request({
